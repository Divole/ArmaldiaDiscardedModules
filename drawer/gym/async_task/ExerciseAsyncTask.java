...
public class ExerciseAsyncTask extends AsyncTask<Void, Void, Boolean> {

    private Context context;
    private URL job_center_url;
    private JSONObject output_json;

    public ExerciseAsyncTask(Context context, int activityID) {
        this.context = context;
        try {
            job_center_url = new URL("http://www.armaldia.com/gym/ajax-exercise/"+activityID+"/1");
